  ...
  head: () => ({
    meta: [
      ...
      { title: "PulseFolio — Portfolio Health & Rebalancing" },
      {
        name: "description",
        content:
          "PulseFolio scores your portfolio 0–100 on diversification, sector concentration and asset-class balance, with concrete rebalancing actions.",
      },
      { name: "author", content: "PulseFolio" },
      { property: "og:title", content: "PulseFolio — Portfolio Health & Rebalancing" },
      {
